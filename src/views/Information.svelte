  ...
  function update_data (e) {
    switch (step) {
      case 1: {
        ...
        area1 = info_data[data].states
        info_type = info_data[data].info_type.name
...
<div class="container-fluid mt-5">
  <div class="row">
    <div class="col-md-2">
      <button class="btn btn-primary w-100"><i class="fas fa-arrow-left"></i>  Previous</button>
    </div>
    <div class="col-md-8">
      <h1 class="h1 title text-center">{title}</h1>
    </div>
    <div class="col-md-2">
      <button class="btn btn-primary w-100">Next  <i class="fas fa-arrow-right"></i></button>
    </div>
  </div>
